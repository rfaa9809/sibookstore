            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                @else
                    ...
                    <div class="flex items-center gap-3">
                        <a href="{{ route('login') }}"
                           class="px-4 py-2 text-sm text-gray-600 transition hover:text-gray-800">
                            Masuk
                        </a>
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            ...
            @else
                ...
                <div class="px-4 pb-3 space-y-2">
                    <a href="{{ route('login') }}"
                       class="block w-full px-4 py-2 text-sm text-center text-gray-600 border border-gray-200 rounded-lg hover:bg-gray-50">
                        Masuk
                    </a>
                    <a href="{{ route('register') }}"
                       class="block w-full px-4 py-2 text-sm text-center text-white bg-blue-600 rounded-lg hover:bg-blue-700">
                        Daftar
                    </a>
                </div>
            @endauth
